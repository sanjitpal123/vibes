document.addEventListener('DOMContentLoaded', () => {
    ...
    if (popupModal && popupClose) {
        ...
        if (popupForm) {
            const popupPhoneInput = document.getElementById('p-contact');
            ...
            popupForm.addEventListener('submit', (e) => {
                ...
                if (popupPhoneInput && popupPhoneError) {
                    const phoneVal = popupPhoneInput.value.trim();
                    if (phoneVal.startsWith('0')) {
                        popupPhoneError.textContent = 'Phone number should not start with 0.';
